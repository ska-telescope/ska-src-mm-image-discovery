...
class SoftwareDiscoveryService:
    ...
    async def get_software_metadata(self, software_name: str, software_type: str) -> list[SoftwareMetadata]:
        ...
        software_metadata_documents = await self.mongo_repository.get_software_metadata(software_name, software_type)
