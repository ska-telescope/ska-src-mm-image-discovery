...
cmd="src.ska_src_mm_image_discovery_api.rest.server:app --host "0.0.0.0" --port 8080 --reload --reload-dir ../models/ --reload-dir ../client/ --reload-dir ../rest/ --reload-dir ../common/ --reload-dir ../../../etc/ --reload-include *.json"
