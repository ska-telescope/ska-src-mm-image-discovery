                ...
                <List component="nav">
                    ...
                    <Collapse in={openSoftware} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItemButton component={Link} to="/web" sx={{color: "#E5096A"}}>
                    ...
                    <Collapse in={openImage} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItemButton component={Link} to="/web/image-discovery/id" sx={{color: "#E5096A"}}>
                                GET Image by ID
                            </ListItemButton>
                            <ListItemButton component={Link} to="/web/image-discovery/type" sx={{color: "#E5096A"}}>
                                GET Image by Type
                            </ListItemButton>
                        </List>
                    </Collapse>
